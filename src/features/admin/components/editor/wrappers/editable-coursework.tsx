            ...
            <section id="coursework" className="py-20 relative bg-black/30">
                <div className="container mx-auto px-4">
                    <div className="flex items-center gap-4 mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-gray-200"><InlineEdit value={sectionTitle || "Relevant Coursework"} onChange={handleTitleChange} placeholder="Section Title" className="text-center" /></h2>
                        <div className="h-px bg-gray-700 flex-1" />
                    </div>
