...
import { Trash2, Plus, Award, ChevronUp, ChevronDown } from 'lucide-react';
            ...
            <section id="certifications" className="py-20 relative bg-[#050505]">
                <div className="container mx-auto px-4">
                    <div className="flex items-center gap-4 mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-purple"><InlineEdit value={sectionTitle || "Certifications"} onChange={handleTitleChange} placeholder="Section Title" className="text-center" /></h2>
                        <div className="h-px bg-gray-700 flex-1" />
                    </div>
