                ...
                <div className="space-y-6 z-10 order-2 lg:order-1">
                    ...
                    <div className="flex gap-6 pt-8 text-gray-400 flex-wrap">
                        ...
                        {socialProfiles?.leetcode && (
                            <a href={socialProfiles.leetcode} target="_blank" rel="noopener noreferrer" className="group/icon transition-colors hover:scale-110 transform duration-200" title="LeetCode">
                                <CustomIcon
                        ...
                        {socialProfiles?.hackerrank && (
                            <a href={socialProfiles.hackerrank} target="_blank" rel="noopener noreferrer" className="group/icon transition-colors hover:scale-110 transform duration-200" title="HackerRank">
                                <CustomIcon
                        ...
                        {socialProfiles?.geeksforgeeks && (
                            <a href={socialProfiles.geeksforgeeks} target="_blank" rel="noopener noreferrer" className="group/icon transition-colors hover:scale-110 transform duration-200" title="GeeksforGeeks">
                                <CustomIcon
                        ...
                        {socialProfiles?.codeforces && (
                            <a href={socialProfiles.codeforces} target="_blank" rel="noopener noreferrer" className="group/icon transition-colors hover:scale-110 transform duration-200" title="Codeforces">
                                <CustomIcon
                        ...
                        {socialProfiles?.codechef && (
                            <a href={socialProfiles.codechef} target="_blank" rel="noopener noreferrer" className="group/icon transition-colors hover:scale-110 transform duration-200" title="CodeChef">
                                <CustomIcon
                        ...
                        {socialProfiles?.kaggle && (
                            <a href={socialProfiles.kaggle} target="_blank" rel="noopener noreferrer" className="group/icon transition-colors hover:scale-110 transform duration-200" title="Kaggle">
                                <CustomIcon
